...
signed main() {
	...
	int a, b, c; cin >> a >> b >> c;
	int plana = (max(0ll,a-100)*25 + 15 * b + 20 * c);
	int planb = (max(0ll,a-250)*45 + 35 * b + 25 * c);
	cout << "Plan A costs " << plana << " cents" << endl;
	cout << "Plan B costs " << planb << " cents" << endl;
	if (plana < planb) cout << "Plan A is cheapest." << endl;
	else if (planb < plana) cout << "Plan B is cheapest." << endl;
