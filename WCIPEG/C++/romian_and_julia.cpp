...
struct Triplet {double fi; double se; double th; Triplet(double a, double b, double c){fi=a;se=b;th=c;} Triplet(){}};
signed main() {
	ios_base::sync_with_stdio(0);cin.tie(0);
	Triplet a, b; double x1, y1, z1, x2, y2, z2; cin >> x1 >> y1 >> z1 >> x2 >> y2 >> z2;
	a.fi = x1; a.se = y1; a.th = z1; b.fi = x2; b.se = y2; b.th = z2;
